...
### Додаткові налаштування для .env
<br />Проект додав WebHook тому додатково необхыдно заповнити:
### 0 BOT_MODE=WEBHOOK 
<br />**WEBHOOK_URL**=host.your/site/webhook
<br />**WEBHOOK_PORT**=8443
<br />**WEBHOOK_PATH**=/site/webhook
<br />**WEBHOOK_SECRET_TOKEN**=YOUR_SECRET_STRING_RANDON_GENERATE
<p />Це перша версія Бота яка запрацювала на безкоштовном хостінгу на базі Python 3/12
за технологією **WSGI** тому задіян Flask у якосты тимчасового рішення
...
Перед запуском, бажано (не обов'язково) зробити видалення минулого контейнеру:
<p />
<code>
